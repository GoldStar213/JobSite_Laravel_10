                            ...
                            <div class="col-12 col-md-6">
                                ...
                                <section class="bg-diffrent">
                                    <div class="w-100 text-center">
                                        <div class="col-xl-12">
                                            <div class="file-upload-contain">
                                                <input id="multiplefileupload" type="file" accept="*.* "
                                                    multiple=false />
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="card m-auto my-5 p-0" id="chat2">
                                    ...
                                    <div class="card-body overflow-y-auto" data-mdb-perfect-scrollbar="true"
                                        ...
                                        <div class="d-flex flex-row justify-content-start">
                                            ...
                                            <div>
                                                <p class="small p-2 ms-3 mb-1 rounded-3 chat-message"
                                        ...
                                        <div class="d-flex flex-row justify-content-end mb-4 pt-1">
                                            <div>
                                                <p
                                                    class="small p-2 me-3 mb-1 text-white rounded-3 bg-active chat-message right">
                                                    こんにちは。</p>
                                                <p
                                                    class="small p-2 me-3 mb-1 text-white rounded-3 bg-active chat-message right">
                                                    こんにちは。</p>
                        ...
                        <div class="answer-list">
                            ...
                            <div
                                ...
                                <div class="answer-item p-1 rounded-3 d-flex gap-4 active" data-type="video"
                                    data-content="./assets/video/interview01.mp4">
                                    <!-- HEADER -->
